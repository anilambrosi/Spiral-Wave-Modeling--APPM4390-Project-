...
EVENT_CONFIG = {
    "events": [
        ...
        # Example templates for later use:
...
# Snapshot times
# -----------------------------------------
snapshot_times = [200.0, 400.0, 451.0, 500.0, 750.0, 1000.0, 1500.0, 1550.0, 1700.0]
...
fig, axes = plt.subplots(nrows, ncols, figsize=(13, 10), constrained_layout=True)
